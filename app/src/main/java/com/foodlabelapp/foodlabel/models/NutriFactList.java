package com.foodlabelapp.foodlabel.models;

public class NutriFactList {

  private static NutriFactList sNutriFactList;
  ...
  public static NutriFactList getInstance() {
    if (sNutriFactList == null) {
      sNutriFactList = new NutriFactList(2000);
    }
    return sNutriFactList;
  }
